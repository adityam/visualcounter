...
\defineframed
  ...
  [ \s!parent=visualcounter,
    ...
    \c!height=\v!fit,
     \c!strut=\v!no,
     \c!frame=\visualcounterparameter\c!frame,
  \c!location=\visualcounterparameter\c!location,
...
\definevisualcounter
   [markers]
   [       \c!mp=visualcounter:dots,
      \c!palette=visualcounter:dots,
        \c!width=1EmWidth,
     \c!distance=1EmWidth,
            path=unitcircle,
   ]
...
\startuseMPgraphic{visualcounter:dots}
  begingroup ;
  ...
  newpath marker ;
  marker := \visualcounterparameter{path} %
...
\definevisualcounter
  ...
  [           \c!mp=visualcounter:pulseline,
			   path={origin -- (((n-1)*width, 0) .. ((n-0.5)*width, -0.2height) 
...
\startuseMPgraphic{visualcounter:pulseline}
  ...
  newpath pulse ;
  pulse := \visualcounterparameter{path} ;
