...
\setupvisualcounter
  [\c!counter=userpage,
   \c!n={\rawstructurecounter[\visualcounterparameter\c!counter]},
   \c!text={\getstructurecounter[\visualcounterparameter\c!counter]},
   \c!max\c!text={\laststructurecounter[\visualcounterparameter\c!counter]},
   \c!last={\laststructurecounter[\visualcounterparameter\c!counter]},
   \c!style=,
   \c!color=,
   \c!mp=,
