...
\setuphead[numbercommand=\visualsection]
...
\subject {Changing the color of counters}
...
\subject {Changing the size of the counters}
...
\subject {Changing the style of text displayed in the counters}
...
\startitemize[packed, joinedup]
  ...
  \item \options{distance} (default value \options{1EmWidth}): The edge to edge
  ...
  \item \options{mpsetups} (default value \options{visualcounter:markers:circle}): 
    ...
    markers. The module comes with two predefined shapes,
    \options{visualcounter:markers:circle} and \goodbreak
    \options{visualcounter:markers:square}.
\stopitemize
...
\section {The \command{progressbar} counter}
...
% \subject[sec:new-counters]{How to define new counters}
